...
@click.option('--q', 'q', help='Weight for the intensity regularizer.', default=0.0001, show_default=True)
@click.option('--q-entropy', 'q_entropy', help='Weight for the entropy regularizer.', default=0.005, show_default=True)
